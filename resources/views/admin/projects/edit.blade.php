        ...
        <div class="row justify-content-center">
            ...
            <form action="{{route('admin.projects.update' , $project)}}" method="POST" id="add-form">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm" type="text" placeholder="Project Name" aria-label="Project Name" name="name" id="name"  value={{old('name' ,$project->name)}} required>
                </div>
